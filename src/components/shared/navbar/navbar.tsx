...
const navItems: NavItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    dropdown: [
      ...
      { label: "Drop Shoulder", href: "/products/dropshoulder" },
      { label: "Racing Collection", href: "/products/racing" },
      { label: "Graphic Tees", href: "/products/graphic-tees" },
    ],
  },
  { label: "Contact", href: "/contact" },
  {
    ...
    dropdown: [
      ...
      { label: "ACCESSORIES", href: "/products/accesseries" },
